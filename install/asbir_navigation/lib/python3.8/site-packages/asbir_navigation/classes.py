...
class Edge:
	def __init__(self,source,target,distance,rotation,source_id=None,target_id=None):
            self.source = source
            self.target = target
...
class FindEdge:
    ...
    def getEdge(self,source,target,dist,tfBuffer):
        ...
        if target_frame != source_frame:
            target_pos = tf2_geometry_msgs.tf2_geometry_msgs.do_transform_point(target_pos, source.surface.frame)
